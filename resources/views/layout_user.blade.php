          ...
          <div class="container-fluid">
            <div class="row align-items-center">
              ...
              <div class="col-xl-2 col-lg-2">
                <div class="logo">
                  <a href="{{ URL::to('/') }}"><img src="{{ asset('/user/img/logo/logo.svg') }}"
                      alt=""></a>
                </div>
              </div>
                        ...
                        <div class="form-group">
                          <div class="input-group mb-3">
                            <input type="text" name="query" class="form-control"
                              placeholder='キーワードで検索' onfocus="this.placeholder = ''"
                              onblur="this.placeholder = 'キーワードで検索'">
                      ...
                      <ul id="navigation" class="d-flex justify-content-end align-items-center">
                        ...
                        @if (Auth::user())
                          ...
                          @else
                            ...
                            <li><a href="{{ URL::to('/posts_follow') }}">フォロイング</a></li>
                        ...
                        @if (!session('status') && auth()->user())
                          <li  class="header-ava">
                            @if (Auth::user()->avatar_url != null)
                                <img
                                  src="/storage/avatar_url/{{ Auth::user()->avatar_url }}">
                            @else
                        ...
                        @else
                          <li class="button-header margin-left ">
                            <a href="{{ URL::to('/register') }}" class="btn">サインアップ</a>
                          </li>
                          <li class="button-header">
                            <a href="{{ URL::to('/login') }}" class="btn btn3">ログイン</a>
                          </li>
                        @endif
                      </ul>
                    </nav>
