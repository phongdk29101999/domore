                          ...
                          @foreach($modelSearchResults as $searchResult)
                            <div class="content row">
                              <div class="col-sm-8" style="">
                                <a href="{{URL::to('/posts/'.$searchResult->searchable->post_id)}}" class="title" style="font-weight: bold;color: black;">{{$searchResult->title}}</a>
                                  <div class="des">{{$searchResult->searchable->description}}</div>
                                  <div class="date" style="font-style: italic"><i class="fa fa-user"></i> {{$searchResult->searchable->user->user_name}}</div>
                                </div>
                              <div class="col-sm-1" >{{$comment_count[$type][$searchResult->searchable->post_id]}}</div>
                              <div class="col-sm-1" style="">{{$like_count[$type][$searchResult->searchable->post_id]}}</div>
                              <div class="col-sm-2" style="">{{$searchResult->searchable->date_create}}</div>
                            </div>
                          <hr>
                          @endforeach
                        </div>
